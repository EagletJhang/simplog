...
exports.generateArticles = function (siteRoot, globalConfig, articlesConfig) {
    // 检测并读取模板文件
    if (fs.existsSync(siteRoot + '/articles/articles.template')) {
        ...
        console.log('[INFO]Read article template completed.');
    } else {
    ...
    articlesConfig.articles.forEach(function (article) {
        console.log('[INFO]Generate article: ' + article.id + '.');
        var ext = '';
